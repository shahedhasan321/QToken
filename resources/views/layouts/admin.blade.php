...
<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" href="{{route('home')}}">QueueToken</a>
    ...
    <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Department</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{route('new.dept')}}"><i class="icon fa fa-circle-o"></i> Add Department</a></li>
                <li><a class="treeview-item" href="{{route('list.dept')}}"><i class="icon fa fa-circle-o"></i> Department List</a></li>
            </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Counter</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{route('counter.new')}}"><i class="icon fa fa-circle-o"></i> Add Counter</a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Token</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{route('manual')}}"><i class="icon fa fa-circle-o"></i> Manual Token</a></li>
                <li><a class="treeview-item" href="{{route('auto')}}"><i class="icon fa fa-circle-o"></i> Auto Token</a></li>
                <li><a class="treeview-item" href="{{route('current.list')}}"><i class="icon fa fa-circle-o"></i> Current Token</a></li>
                <li><a class="treeview-item" href="{{route('list')}}"><i class="icon fa fa-circle-o"></i> Token List</a></li>
            </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa  fa-user"></i><span class="app-menu__label">User</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{route('user.new')}}"><i class="icon fa fa-user-plus"></i> Add User</a></li>
                <li><a class="treeview-item" href="{{route('user.list')}}"><i class="icon fa fa-users"></i> User List</a></li>
            </ul>
        </li>
        <li><a class="app-menu__item" href="{{route('token.display')}}"><i class="app-menu__icon fa fa-television"></i><span class="app-menu__label">Diaplay</span></a></li>
        <li>
