...
<div class="app-title" >
    ...
    <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">{{ Auth::user()->role }} / Update Counter</a></li>
    </ul>
</div>
    <div class="col-md-6">
        @if ($errors->any())
        ...
        <div class="tile">
            <h3 class="tile-title">Update Counter</h3>
            <div class="tile-body">
                    ...
                    <div class="tile-footer">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-3">
                                <button class="btn btn-info" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="{{route('counter.list')}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
